...
from .paint import DrawLine, DrawOutline, DrawRect, DrawText, Rect
from .url import URL
...
class Chrome:
    def __init__(self, browser):
        ...
        self.font_height = self.font.getMetrics().fDescent - self.font.getMetrics().fAscent
        self.padding = 5
        ...
        self.address_rect = Rect(
            ...
            800 - self.padding, self.urlbar_bottom - self.padding,
        )
    ...
    def paint(self):
        ...
        cmds.append(DrawRect(Rect(0, 0, 800, self.bottom), "white"))
        cmds.append(DrawLine(0, self.bottom, 800, self.bottom, "black", 1))
        ...
        for i, tab in enumerate(self.browser.tabs):
            ...
            if tab == self.browser.active_tab:
                ...
                cmds.append(DrawLine(bounds.right, bounds.bottom, 800, bounds.bottom, "black", 1))
        ...
        if self.focus == "address bar":
            ...
            cmds.append(DrawLine(
                self.address_rect.left + self.padding + w, self.address_rect.top,
                self.address_rect.left + self.padding + w, self.address_rect.bottom,
                "red", 1,
            ))
        elif self.browser.active_tab is not None:
